...
northstar:::col_lb("md", "pfs") |> 
  gt(rowname_col = "var") |>
  northstar:::gt_style(tablign = "right")
```
...
northstar:::col_lb("md", "rvu") |> 
  gt(rowname_col = "var") |>
  northstar:::gt_style(tablign = "left")
```
...
dplyr::tibble(mod = c("26", "TC", "53")) |> 
  ...
  tab_footnote(fmod) |> 
  northstar:::gt_style(tablign = "center", tabsize = 18)
```
...
gpci() |> 
  ...
  northstar:::gt_style(tablign = "center", tabsize = 14) |> 
