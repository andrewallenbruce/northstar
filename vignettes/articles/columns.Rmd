...
dplyr::tibble(mod = c("26", "TC", "53")) |> 
  ...
  tab_footnote(fmod) |> 
  gt_style(tablign = "center", tabsize = 18)
```
...
gpci() |> 
  ...
  tab_footnote(footnote = macas, locations = cells_stubhead()) |> 
  tab_footnote(footnote = md(alaska), cells_body(columns = locality, rows = 1)) |> 
  tab_footnote(footnote = frontier, cells_body(columns = locality, rows = c(68, 70, 81, 91, 109))) |> 
  tab_footnote(footnote = md(note)) |>
  gt_style(tablign = "center", tabsize = 14) |> 
